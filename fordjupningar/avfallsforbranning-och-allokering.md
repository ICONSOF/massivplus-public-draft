...
>
> **Steg 1 - dela mellan utflödena.** Anläggningen fördelar sina 1000 ton mellan de två utflödena med en dokumenterad metod. Hur stor del som hamnar på respektive utflöde är metodvalet (energi- kontra avfallsperspektiv) och avgörs inte av standarden i sig. Olika branscher kan ha olika sätt att luta sig mot praxis - och egna stödsystem för att hjälpa till med det praktiskt. Antag att 600 ton läggs på behandlingstjänsten och 400 ton på värmen.
>
