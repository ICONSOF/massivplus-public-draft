...
**Mitigering:** strikt separation av A och U, transparent Coverage-rapportering, tydlig kommunikation om att U är temporärt och att A alltid prioriteras, samt aktiv positionering av standarden som komplement till befintliga ramverk - inte ersättning. Se [jämförelse med andra ramverk](../positionering/jamforelse-med-andra-ramverk.md) för hur relationen till GHG Protocol, ISO 14064-1, EPD, PACT, Catena-X och PCAF (finanssektorns standard för utsläpp knutna till lån och investeringar) konkret ser ut.
