...
På produktnivå gör EPD, ISO 14067, PACT och Catena-X redan exakt detta - leverantören räknar sin produkts livscykel, publicerar en deklaration, och kunder konsumerar resultatet utan att se underliggande affärsdata. MASSIV+:s bidrag är att tillämpa samma informationsekonomi på *organisationsnivå*, där data är mer åtkomlig, tröskeln dramatiskt lägre, och propageringen kan ske kontinuerligt - inte som ögonblicksbilder vart femte år.

Många större bolag gör redan en informell variant av detta på organisationsnivå för att kunna rapportera Scope 3 kategori 1, alltså inköpta varor och tjänster. Metoderna varierar. Rådata begärs in från förstaledsleverantörer, alltså dem man handlar direkt med: total energiförbrukning och total producerad volym, följt av egen volymbaserad allokering. LCA:er från samma led används som indata. Eller så görs egna interna beräkningar utifrån inköpt material, i kronor, kilo eller annat mått. Alla tre är approximationer av nodprincipen.

Konsekvenserna av att improvisera är välkända. Leverantörens affärskritiska data exponeras med risk för missbruk i prisförhandlingar. Allokeringen blir grov när volymen har annan energiintensitet än övrig produktion. Andra och tredje ledet blir en svart låda som måste fyllas med branschschabloner. Och revisorer ställer berättigade frågor om hur luckorna är hanterade. MASSIV+ flyttar allokeringsansvaret till parten som har informationen, standardiserar vilken information som utbyts, och ger systemkonsistens utan central samordning.
...
**Storleken på bolaget** påverkar främst drivkraften, inte nyttan. Storbolag drivs av sin egen CSRD-rapportering enligt ESRS E1, klimatkapitlet i EU:s hållbarhetsstandard, och av åtaganden under Science Based Targets initiative (SBTi). De vinner framför allt på att revisionskostnaden flyttar från att försvara metodval till att verifiera standardefterlevnad: tid och konsultarvoden som idag går åt till att motivera godtyckliga val, som vilken emissionsfaktordatabas eller vilken allokeringsregel man valt, blir mekaniskt verifieringsarbete.

För mindre bolag, under 1 000 anställda, gäller CSRD:s value chain cap, alltså gränsen i reviderade ESRS för hur mycket data stora bolag får kräva av mindre leverantörer. Stora kunder får inte längre begära mer än Voluntary Standard Basic i ren rapporteringsfråga. Drivkraften ligger därför utanför capen: frivilliga sektoröverenskommelser, upphandlingskriterier, operativ utsläppsminskning, och banksidan, vars klimatrisktillsyn capen inte begränsar. De fyra kanalerna beskrivs i [EU:s rapporteringsarkitektur](jamforelse/eu-rapporteringsarkitektur.md).

Nyttan är densamma oavsett storlek: låg ingångströskel, en deklaration som duger mot alla kunder, och samma data som indata i PCF och EPD. Det som skiljer är positioneringen, som för den mindre aktören är frivillig värdedelning.
