...
> Del av [Jämförelse med andra ramverk](../jamforelse-med-andra-ramverk.md) - översiktstabell och sammanfattande positionering finns där. ISO 14064-1 och [GHG Protocol](ghg-protocol.md) verkar på samma nivå som MASSIV+ - organisationen snarare än produkten. Ny här? Läs [introduktionen](../../introduktion.md) först.
