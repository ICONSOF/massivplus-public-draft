...
PCAF är finanssektorns standard för finansierade utsläpp, alltså de utsläpp en bank eller investerare bär via sin utlåning och sina innehav. Den är en egen kategori: en portföljallokeringsmetod som behöver kunddata MASSIV+ kan leverera.

---

## MASSIV+ vs. PCAF

PCAF (Partnership for Carbon Accounting Financials) är finanssektorns standard för att mäta utsläpp kopplade till lån, investeringar och försäkringar. Tredje utgåvan (december 2025) täcker tio tillgångsklasser: noterade och onoterade aktier, företagsobligationer, företagslån, projektfinansiering, kommersiella fastigheter, bolån, fordonslån och statsskuld, samt de nya tilläggen värdepapperiseringar och strukturer med öronmärkt låneändamål. Standarden fördelar låntagarens eller investeringsobjektets utsläpp till finansiella aktörer proportionellt mot deras finansieringsandel via en *attribution factor* - utestående belopp dividerat med totalt eget kapital plus skulder för onoterade bolag, eller med EVIC (Enterprise Value Including Cash, bolagsvärde inklusive kassa) för noterade. De finansierade utsläppen är vad finansiella aktörer rapporterar som sin Scope 3 kategori 15.
